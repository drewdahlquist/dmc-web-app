...
import { FormClose, Notification, Menu, Favorite, ShareOption, } from 'grommet-icons'
...
const ExperimentCards = ({ data }) => (data.map((value) => (
  <Card style={{ height: 'small', width: '95%', minHeight: '222px' }} background="light-1" margin='xsmall'>
    ...
    <CardBody pad={{ horizontal: "small" }}>
      <ExpCardBody positions={value.positions} frequency={value.frequency} endDate={value.endDate} />
    </CardBody>
      ...
      <ResponsiveContext.Consumer>
        {size => (
          <Box fill>
            ...
            <AppBar>
              what can go here?
              <Heading level='3' margin='none'>DMC Phenotyping</Heading>
